...
// Sign in Friendly Char with Facebook
function signInFc() {
...
function requestNotificationsPermissions() {
  // TODO 11: Request permissions to send notifications.
	...
	firebase.messaging().requestPermission().then( function() {
		...
		console.error( 'Unable to get oermission to notify',error );
	});
}
...
signInGoogleButtonElement.addEventListener('click', signIn);
signInFacebookButtonElement.addEventListener('click',signInFc );
